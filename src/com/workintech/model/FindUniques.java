...
public class FindUniques {
    ...
    public static int findUniques(String input) {

        String[] splitted = input.split("[\".,?_!'—\s]");
    ...
    public static void main(String[] args) {
        String input = ("Carroll began writing the manuscript of the story the next day, although that earliest version is lost. " +
        ...
        System.out.println(findUniques(input));
    }
